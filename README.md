...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'o'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-o@main/recipes/<cuisine>/<diet>/<slug>.json
```
